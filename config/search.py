...
search_terms = ["DevOps Engineer", "Senior DevOps Engineer", "Platform Engineer", "Site Reliability Engineer", "Cloud Engineer", "Azure DevOps Engineer", "Kubernetes Engineer", "Infrastructure Engineer", "DevOps Lead", "Cloud Infrastructure Engineer", "DevOps Architect", "Terraform Engineer"]
...
bad_words = ["US Citizen", "USA Citizen", "US Citizenship", "USA Citizenship", "Security Clearance", "Polygraph", "Green Card holder", "Must be located in the United States", "Intern", "Interns", "Internship", "Internships", "Fresher", "Freshers"]   # (dynamic multiple search) or leave empty as []. Case Insensitive, matched as whole words/phrases. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
'''
Note: Removed the template's ".NET", "PHP", "Ruby" entries. Enterprise DevOps postings routinely mention
the app stacks they build (your own TCS role covered .NET CI/CD), so those words would skip relevant jobs.
'''
...
current_experience = 14            # Integers > -2 (Ex: -1, 0, 1, 2, 3, 4...)
##
